...
def test_simple_main_function():
    ...
    assert_units(code, Language.C, {"main": 3})
...
def test_main_function_with_include():
    ...
    assert_units(code, Language.C, {"main": 4})
...
def test_simple_function():
    ...
    assert_units(code, Language.C, {"bar": 3})
...
def test_multiple_functions():
    ...
    assert_units(code, Language.C, {"bar": 3, "foo": 3})


def test_no_functions():
    code = ""

    assert_units(code, Language.C, {})
...
def test_iteration_macro_is_not_a_function():
    ...
    assert_units(code, Language.C, {'foo': 5})
...
def test_formatting():
    ...
    assert_units(code, Language.C, {'nfs_register_sysctl': 7})
