...
def test_simple_function_larger_block():
    ...
    assert_units(code, LanguageName.Python, {"foo": 3})
...
def test_return_type():
    ...
    assert_units(code, LanguageName.Python, {"bar": 4})
...
def test_two_functions_with_return_types():
    ...
    assert_units(code, LanguageName.Python, {"bar": 4, "foo": 4})
...
def test_no_functions():
    ...
    assert_units(code, LanguageName.Python, {})
...
def test_header_with_defaults():
    ...
    assert_units(code, LanguageName.Python, {"foo": 9})
...
def test_header_type_hints():
    ...
    assert_units(code, LanguageName.Python, {"foo": 4})
...
def test_skip_function_with_nocl_comment_in_header():
    ...
    assert_units(code, LanguageName.Python, {"foo": 5})
...
def test_line_continuation():
    ...
    assert_units(code, LanguageName.Python, {"say_hello": 4})
...
def test_if_statement():
    ...
    assert_units(code, LanguageName.Python, {"foo": 6})
