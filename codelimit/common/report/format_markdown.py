...
def print_report(report: Report, console: Console):
    console.print("## CodeLimit Report")
    console.print("")
    ...
    console.print("")
    console.print("Generated by [CodeLimit](https://getcodelimit.github.io)")
...
def print_findings(report: Report, console: Console, full: bool = False):
    ...
    if not full and len(functions) > 10:
        console.print()
        console.print(f"{len(functions) - 10} more rows", style="bold")
